...
class LabelTool():
    ...
    def loadDir(self, dbg=False):
        ...
        self.imageDir = os.path.join(r'/Users/xingoo/Documents/brands/images/', '%03d' % (self.category))
        print(self.imageDir)
        ...
        # set up output dir
        self.outDir = os.path.join(r'/Users/xingoo/Documents/brands/labels/', '%03d' % (self.category))
        if not os.path.exists(self.outDir):
            os.mkdir(self.outDir)

        # load example bboxes
        self.egDir = os.path.join(r'/Users/xingoo/Documents/brands/Examples/', '%03d' % (self.category))
